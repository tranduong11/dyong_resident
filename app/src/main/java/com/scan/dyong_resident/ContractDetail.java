...
public class ContractDetail extends AppCompatActivity {
    ...
    TextView tvRoom, tvOwner,tvNgayBatDau, tvNgayKetThuc, tvTienNha, tvTienCoc, tvInternet,
            tvNuocUong, tvNuocUongTheoNguoi, tvTienDien,txt_hoTenNguoiThue;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_hoTenNguoiThue = findViewById(R.id.txt_hoTenNguoiThue);
        ...
        if (contract != null) {
            ...
            txt_hoTenNguoiThue.setText("Người thuê: " + contract.getTenant());
        }
    }
}