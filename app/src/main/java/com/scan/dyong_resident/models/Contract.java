...
//    public Contract(int id, String room, String owner, int quantity, String ngayKy, String ngayBatDau, String ngayKetThuc,
//                    double tienNha, double tienCoc, double internet, double nuocUong, double nuocUongTheoNguoi,
//                    double tienDien, double mayGiat, String khac, String tenant) { // Thêm tham số tenant vào constructor
//        this.id = id;
//        this.room = room;
//        this.owner = owner;
//        this.quantity = quantity;
...
//        this.mayGiat = mayGiat;
//        this.khac = khac;
//        this.tenant = tenant; // Gán giá trị cho trường tenant
//    }
//
//    // Getter và Setter
//    public int getId() {
...
//    }
//
//    public String getTenant() {  // Getter cho trường tenant
//        return tenant;
//    }
//
//    public void setTenant(String tenant) {  // Setter cho trường tenant
//        this.tenant = tenant;
//    }
//}
package com.scan.dyong_resident.models;
...
public class Contract implements Serializable {
    ...
    private String khac;
    private String tenant;
    private String emailNguoiThue;  // Thêm trường emailNguoiThue

    // Constructor cập nhật để thêm emailNguoiThue
    public Contract(int id, String room, String owner, int quantity, String ngayKy, String ngayBatDau, String ngayKetThuc,
                    double tienNha, double tienCoc, double internet, double nuocUong, double nuocUongTheoNguoi,
                    double tienDien, double mayGiat, String khac, String tenant, String emailNguoiThue) {
        this.id = id;
        this.room = room;
        this.owner = owner;
        this.quantity = quantity;
        ...
        this.khac = khac;
        this.tenant = tenant;
        this.emailNguoiThue = emailNguoiThue;  // Gán giá trị cho emailNguoiThue
    }
    ...
    public String getEmailNguoiThue() {  // Getter cho trường emailNguoiThue
        return emailNguoiThue;
    }

    public void setEmailNguoiThue(String emailNguoiThue) {  // Setter cho trường emailNguoiThue
        this.emailNguoiThue = emailNguoiThue;
    }
}
