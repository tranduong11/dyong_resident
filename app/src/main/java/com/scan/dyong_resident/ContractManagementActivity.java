...
public class ContractManagementActivity extends AppCompatActivity implements ContractAdapter.OnContractActionListener {
    ...
    private void showUpdateDialog(Contract contract) {
        View dialogView = LayoutInflater.from(this).inflate(R.layout.dialog_update_contract, null);
                ...
                .setPositiveButton("Cập nhật", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (TextUtils.isEmpty(phong) || TextUtils.isEmpty(chuHopDong) || TextUtils.isEmpty(soLuong)) {
                            Toast.makeText(ContractManagementActivity.this, "Vui lòng nhập đầy đủ thông tin.", Toast.LENGTH_SHORT).show();
                            return;
                        }
                        ...
                        if (isUpdated) {
                            Toast.makeText(ContractManagementActivity.this, "Cập nhật hợp đồng thành công!", Toast.LENGTH_SHORT).show();
                            contractList.set(contractList.indexOf(contract), contract);
                            adapter.notifyDataSetChanged();
                        } else {
                            Toast.makeText(ContractManagementActivity.this, "Cập nhật hợp đồng thất bại.", Toast.LENGTH_SHORT).show();
                        }
                    }
                })
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Đồng ý", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        Toast.makeText(ContractManagementActivity.this, "Hợp đồng đã được xóa.", Toast.LENGTH_SHORT).show();
                    }
                })
    ...
    public void onContractClick(Contract contract) {
        Intent intent = new Intent(ContractManagementActivity.this, ContractDetail.class);
